...
declare type ShardOp = import('./shard/shardOp')
declare type ShardChildOp = import('./shard/meta_shardChildOp');
declare type MapOp = import('./shard/mapOp');
...
declare type ColonizingOp = import('./shard/colonizingOp');
