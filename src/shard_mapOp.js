        ...
        for (let roomName in this._roomInfo) {
            ...
            for (let x=0;x<50;x++) {
                for (let y=0;y<50;y++) {
                    ...
                    roomInfo.terrainArray[x][y].fatigueCost = Math.min(100*MIN_ROAD_FATIGUE_COST, Math.max(-1 * MIN_ROAD_FATIGUE_COST, roomInfo.terrainArray[x][y].fatigueCost -repairCost));
                }
            }
        }
    }
